# Email sequence — CuePoint launch (SIGNAL)
...
How many apps did you touch to book and run your last wedding?

Texts. Sheets. Docs. Spotify. Venmo notes.
...
• CRM pipeline built for how DJs book
• Music planning with Spotify + client sync
• Contracts with e-sign
• Invoices, expenses, mileage, profit
• Branded client portal
• CUE — AI that uses YOUR business data
...
2. Add packages
3. Create your next event
4. Send a contract or open the portal

Talent books the first gig. Systems book the tenth.
...
If something's blocking you (migration, questions, pricing), reply to this email. A human reads it.
